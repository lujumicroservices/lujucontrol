...
function UsersList() {
	...
	const groupedFilteredUsers = useAppSelector(selectGroupedFilteredUsers(filteredData));
	...
	return (
		...
		>
			{Object.entries(groupedFilteredUsers).map(([key, group]: [string, GroupedUsers]) => {
				return (
					<div
						key={key}
						className="relative"
