...
import { MembersEmailModel } from '../../models/MembersModel';
import { MembersEmail } from '../../MembersApi';

type MembersEmailSelectorProps = {
	value: MembersEmail[] | undefined;
	...
	return (
		...
		>
			...
			<Button
				...
				onClick={() => value && onChange([...value, MembersEmailModel({})])}
			>
...
export default MembersEmailSelector;
