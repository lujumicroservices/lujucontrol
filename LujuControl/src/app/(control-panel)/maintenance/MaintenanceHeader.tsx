...
import { setSearchText, resetSearchText, selectSearchText } from './maintenanceAppSlice';
import { selectFilteredMaintenanceList, useGetMaintenanceListQuery } from './MaintenanceApi';
	...
	return (
		<div className="p-6 sm:p-8 w-full">
			...
			<div className="flex flex-col space-y-1">
				...
				>
					<Typography className="text-4xl font-extrabold leading-none tracking-tight">Maintenance</Typography>
				</motion.span>
				<motion.span
				...
				>
					...
					>
						{`${filteredData?.length} maintenance`}
					</Typography>
				</motion.span>
			</div>
