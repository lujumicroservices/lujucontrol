...
/**
 * The {{moduleNameLower}} header.
 */
function {{moduleName}}Header() {
	...
	return (
		<div className="p-6 sm:p-8 w-full">
			...
			<div className="flex flex-col space-y-1">
				...
				>
					<Typography className="text-4xl font-extrabold leading-none tracking-tight">{{moduleName}}</Typography>
				</motion.span>
				<motion.span
				...
				>
					...
					>
						{`${filteredData?.length} {{moduleNameLower}}`}
					</Typography>
				</motion.span>
			</div>
			<div className="flex flex-1 items-center mt-4 space-x-2">
				...
				>
					...
					<Input
						placeholder="Search {{moduleNameLower}}"
...
export default {{moduleName}}Header;