...
import { selectFilteredResidentList, useGetResidentListQuery } from './ResidentApi';
	...
	return (
		<div className="p-6 sm:p-8 w-full">
			...
			<div className="flex flex-col space-y-1">
				...
				>
					<Typography className="text-4xl font-extrabold leading-none tracking-tight">Resident</Typography>
				</motion.span>
				<motion.span
