...
export const getMaintenanceDisplayData = (maintenanceData: Maintenance) => ({
  fullName: `${ maintenanceData.first_name} ${ maintenanceData.last_name}`,
  fullAddress: `${ maintenanceData.address_line_1}, ${ maintenanceData.address_line_2 ? maintenanceData.address_line_2 + ", " : ""}${ maintenanceData.city}, ${ maintenanceData.state}, ${ maintenanceData.country} - ${ maintenanceData.postal_code}`,
});
